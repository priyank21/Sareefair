<?php
// file containing custom link for seller in line number 152
class ControllerAccountLogin extends Controller {
	...
	public function index() {
		...
		$data['text_register_seller_account'] = $this->language->get('text_register_seller_account');
		...
		//seller account custom url
		$data['registerseller'] = $this->url->link('account/registerseller', '', true);
