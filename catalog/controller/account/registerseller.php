...
class ControllerAccountRegisterseller extends Controller {
	...
	public function index() {
		...
		$data['action'] = $this->url->link('account/registerseller', '', true);
	...
	private function validate() {
		...
		if (trim(is_numeric($this->request->post['firstname']))){  
			$this->error['firstname'] = $this->language->get('error_firstname_alpha');
			
		}  
		if (trim(is_numeric($this->request->post['lastname']))){  
			$this->error['lastname'] = $this->language->get('error_lastname_alpha');
		...
		if (trim(!is_numeric($this->request->post['telephone'])) && strlen($this->request->post['telephone']) > 3){  
			$this->error['telephone'] = $this->language->get('error_telephone_alpha');
