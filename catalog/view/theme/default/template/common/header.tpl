      ...
      <ul class="list-inline">
        ...
        <li class="dropdown"><a href="<?php echo $account; ?>" title="<?php echo $text_account; ?>" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $text_account; ?></span> <span class="caret"></span></a>
          <ul class="dropdown-menu dropdown-menu-right">
            ...
            <li><a href="<?php echo $register; ?>"><?php echo $text_register_seller; ?></a></li>
            <li><a href="<?php echo $login; ?>"><?php echo $text_login; ?></a></li>
            <?php } ?>
          </ul>
        </li>
        <?php if ($logged && ($seller == 1) && ($check_if_seller_exists_or_not == 1)) { ?>
        <li class="dropdown"><a href="<?php echo $account; ?>" title="<?php echo $text_clerkad; ?>" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $text_clerkad; ?></span> <span class="caret"></span></a>
          <ul class="dropdown-menu dropdown-menu-right">
