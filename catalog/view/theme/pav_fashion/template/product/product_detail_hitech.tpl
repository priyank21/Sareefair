...
<div class="product-info">
	...
	<div class="col-xs-12 col-sm-<?php echo $cols[1]; ?> col-md-<?php echo $cols[1]; ?> col-lg-<?php echo $cols[1]; ?>">
        ...
        <div id="product" class="product-extra ">
            ...
            <div class="action">
                <div class="cart">
                    <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-default"><i class=" fa fa-shopping-cart"></i><?php echo $button_cart; ?></button>
                </div>
                <div class="wishlist">  
                    <a  data-toggle="tooltip" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product_id; ?>');"><i class="fa fa-heart"></i><?php echo $button_wishlist; ?></a>
                </div>
                <div class="compare">
                    <a  data-toggle="tooltip"  title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product_id; ?>');"><i class=" fa fa-retweet"></i><?php echo $button_compare; ?></a>
                </div>
            </div>
