...
class ModelAccountCustomer extends Model {
	...
	public function getSellerifExists() {
		$get_seller_data_if_exits = $this->db->query("SELECT * FROM `" . DB_PREFIX . "seller` WHERE seller_id = '" . $this->customer->getId() . "'");
		if ($get_seller_data_if_exits->num_rows != 0) {
			$seller_exists = 1;
