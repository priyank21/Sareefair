              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><?php if ($customer['approve']) { ?>
                    ...
                    <?php if ($customer['sellerapprove']) { ?>
                    <a href="<?php echo $customer['sellerapprove']; ?>" data-toggle="tooltip" title="<?php echo $button_seller_approve; ?>" class="btn btn-success"><i class="fa fa-user-plus"></i></a>
                    <?php } else { ?>
                    <button type="button" class="btn btn-success" disabled><i class="fa fa-thumbs-o-up"></i></button>
                    <?php } ?>
