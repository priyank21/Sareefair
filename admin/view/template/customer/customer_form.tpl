                ...
                <div class="col-sm-10">
                  <div class="tab-content">
                    <div class="tab-pane active" id="tab-customer">
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-approved"><?php echo $entry_seller_approved; ?></label>
                        <div class="col-sm-10">
                          <select name="seller_approved" id="input-sellerapproved" class="form-control">
